                        ...
                        allTransactions?.filter((data)=>{
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <td><button onClick={()=>{returnBook(data._id,data.borrowerId,data.bookId,(Math.floor(( Date.parse(moment(new Date()).format("MM/DD/YYYY")) - Date.parse(data.toDate) ) / 86400000)))}}>Trả sách</button></td>
                                </tr>
                            )
                        })
                    }
                        ...
                        allTransactions?.filter((data)=>{
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <td>{data.fromDate}</td>
                                    <td>{data.toDate}</td>
                                    <td><button onClick={()=>{convertToIssue(data._id)}}>Cho mượn</button></td>
                                </tr>
                            )
                        })
                    }
